...
/// <summary>
/// Represents a light blue box that inherits from BaseBox.
...
public class LightBlueBox : BaseBox
{
    /// <summary>
    /// The name of the box, set to "LightBlue".
    /// </summary>
    [SerializeField]
    private string m_BoxName = "LightBlue";
    ...
    public override void ReleaseObjectPool()
    {
        ...
        // Release the lightBlueBox back to the pool
